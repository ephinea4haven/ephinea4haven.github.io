...
| `sync_anniversary_milestones.mjs` | Synchronize the official 2026 milestone snapshot, its shared landing/detail UTC+8 timestamp (minute precision), and the eight anniversary boost dimensions from fixed Weekly Boost baselines plus unlocked milestone rewards. |
