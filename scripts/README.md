...
| `sync_anniversary_milestones.mjs` | Synchronize the official 2026 milestone snapshot and recalculate the eight anniversary boost dimensions from fixed Weekly Boost baselines plus unlocked milestone rewards. |
