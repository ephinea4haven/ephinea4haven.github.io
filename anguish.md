...
它既不是替代U难度，也不是U难度的推进一种形式，它只是一种自我挑战的方式(类似于暗黑3的Torment模式，U难度相当于A0，苦痛共10个等级[A1-A10]), 可以增加收集常规武器乐趣。
当你提升苦痛难度的等级，那么怪物和奖励也会相应的提升和加强:
...
常规武器掉率**3是对应低级区域**，**4是对应高级区域**，**5对应红盒**。(0、1、2、3、4在普通模式都覆盖、5只是针对红盒)  
