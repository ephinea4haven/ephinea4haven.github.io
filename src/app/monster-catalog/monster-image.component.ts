...
export class MonsterImageComponent {
  readonly src=input<string|null>(null);readonly name=input('');readonly unavailable=input('');readonly failed=linkedSignal({source:this.src,computation:():string|null=>null});
}
