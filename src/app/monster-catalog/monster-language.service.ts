...
const messages: Record<string,[string,string]> = {
  ...
  '稀有掉落':['Rare drops','レアドロップ'], '资料来源':['Sources','出典'], '暂无此难度与模式的属性记录':['No stats recorded for this difficulty and mode','この難易度・モードの能力値は未収録です'], '来源表格（英文原文）':['Source tables (English)','出典の表（英語原文）'],
