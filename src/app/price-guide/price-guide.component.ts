...
const SECTION_LABELS: Readonly<Record<string, string>> = {
  ...
  'Common weapons - Technique commons': '普通武器 - 法系', 'Common weapons - Combination commons': '普通武器 - 组合',
  ...
  'Rare weapons - Technique weapons': '稀有武器 - 法系', 'Rare weapons - ES weapons': '稀有武器 - ES武器',
  ...
  Techniques: '术法', 'Techniques - Technique sets': '术法 - 职业套装', 'Techniques - Individual techniques': '术法 - 单项价格',
...
const CATEGORY_LABELS: Readonly<Record<string, string>> = {
  ...
  Mags: '玛古', Tools: '道具', Techniques: '术法', Meseta: '美赛塔', Services: '服务',
};
const HEADER_LABELS: Readonly<Record<string, string>> = {
  ...
  Technique: '术法', 'Technique disks': '术法光盘', Total: '合计', Merge: '增幅盾', 'Specials Offered': '可添加的特殊攻击',
