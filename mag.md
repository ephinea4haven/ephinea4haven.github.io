...
* 3连PB(一定有双子), 61 + 6 * 3次 = 79级, 61 + 6 * 3次 * 0(人)
* 2连PB(一定有双子), 41 + 6 * 2次(单人) * 1(人) = 53级, 41 + 6 * 2次(单人) * 2(人)  = 65级
* 1PB双子,3捐 21 + 6 * 1 * 3 = 39级,2捐 21 + 6 * 1 * 2 = 33级,1捐 21 + 6 * 1 * 1 = 27级

--- 

## <a name="trigger"></a>激活条件

* 玛古1/10HP激活条件: 角色HP瞬间扣去20%以上并且最终值处于10%以下
* Boss房激活无需解释
* 100PB激活无需解释
